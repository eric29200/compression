 ...
 */
static void __write_huff_header(struct huff_node_t **huff_nodes_lit, struct huff_node_t **huff_nodes_dist,
                                struct bit_stream_t *bs_out)
{
  int i, n;
 ...
 */
static void __write_huff_content(struct lz77_node_t *lz77_nodes, struct huff_node_t **huff_nodes_lit,
                                 struct huff_node_t **huff_nodes_dist, struct bit_stream_t *bs_out)
{
  struct lz77_node_t *lz77_node;
 ...
 */
static int __read_huff_content(struct huff_node_t *huff_tree_lit, struct huff_node_t *huff_tree_dist,
                               struct bit_stream_t *bs_in, char *buf_out)
{
